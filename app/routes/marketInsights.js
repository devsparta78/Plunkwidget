...
// Route
router.get("/measures/:measure/:regionType", async (req, res) => {
  // Path and Query params
  const { measure, regionType } = req.params;
  ...
  // Url and options
  const url = `${API_MARKET_INSIGHTS_URL}/${measure}/${regionType}?region_id=${region_id}`;
  const options = {
    method: "GET",
    headers: {
